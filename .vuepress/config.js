module.exports = {
  ...
  description: 'FriendsFingers DAO official web site',
  head: [
  ...
  chainWebpack: (config) => {
    ...
    config.plugin('injections').tap(pluginArgs => pluginArgs.map(definitions => ({
      ...
      '__DAO_ADDESS__': JSON.stringify(isProd ? '' : '0x82e62db5f2824029f479b70fd5c152c549082480'), // eslint-disable-line max-len
