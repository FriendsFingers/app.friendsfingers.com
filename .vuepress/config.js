module.exports = {
  ...
  chainWebpack: (config) => {
    ...
    config.plugin('injections').tap(pluginArgs => pluginArgs.map(definitions => ({
      ...
      '__FAUCET_ADDESS__': JSON.stringify(isProd ? '0x87d9EF8951DE64b7246fdb7c7D5a52760677f361' : '0x746edCd06B47c2483F6B34e3F79367E38C068884'), // eslint-disable-line max-len
