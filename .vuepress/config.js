module.exports = {
  ...
  chainWebpack: (config) => {
    ...
    config.plugin('injections').tap(pluginArgs => pluginArgs.map(definitions => ({
      ...
      '__TOKEN_DEALER__': JSON.stringify(isProd ? '' : '0x5Ce7459CDBE13F9919083A16B80E2008C55aa94c'), // eslint-disable-line max-len
      '__CONTRIBUTIONS__': JSON.stringify(isProd ? '' : '0x3798b43d1865843c6fd795902484fFc758F8df36'), // eslint-disable-line max-len
